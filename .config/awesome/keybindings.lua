-- keybindings.lua
-- Defines global and client-specific key bindings.
...
clientkeys = gears.table.join(
  ...
  awful.key({ modkey }, "Tab", function(c) -- Removed `cyclefocus` as it's not a standard AwesomeWM module.
    awful.client.focus.bydirection("left") -- Or consider awful.client.focus.history.previous() or a custom cycle function
